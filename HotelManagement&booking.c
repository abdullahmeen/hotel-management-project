...
void viewbookings()
{
    ...
    if (customerCount == 0)
    {
        printf(" No bookings have been made yet\n");
    }
    else
    {
        for (int i = 0; i < customerCount; i++)
        {
            ...
            printf("  Room ID    : %d\n", customers[i].roomID);
            printf("  Nights     : %d\n", customers[i].nights);
            printf("  Room Type  : %s\n", (customers[i].roomType == SINGLE) ? "Single" : "Double");
            printf("  Bill       : %.2f\n", customers[i].bill);
            printf("=============================================\n");
        }
        ...
        {
            printf("All rooms have been booked.Hotel is at full capacity!\n");
        }
    }
...
void resetrooms()
{
    ...
    saverooms();
    printf("=============================================\n");
    printf("    All rooms have been reset to vacant.\n");
    printf("=============================================\n");
    getch();
}
